...
import { generateLog, detectThreat, type LogEntry, type ThreatAlert } from "@/lib/log-simulator"
import {
  Shield,
  Menu,
  X,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 flex">
      ...
      <div className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ${sidebarOpen ? "lg:ml-0" : ""}`}>
        ...
        <motion.header
          ...
          className="border-b border-white/20 bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl sticky top-0 z-40 shadow-lg"
        >
              ...
              <div className="flex items-center space-x-4">
                ...
                <motion.div whileHover={{ scale: 1.02 }} className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400">Advanced Threat Detection System</p>
                  </div>
                </motion.div>
              </div>
                ...
                <div className="flex items-center space-x-2">
                  <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="shadow-lg border-slate-200 dark:border-slate-600 bg-white/50 dark:bg-slate-700/50 hover:bg-white dark:hover:bg-slate-600"
                    >
                            ...
                            <div className="space-y-3">
                              <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <span className="font-medium text-slate-800 dark:text-slate-200">Export logs</span>
                                </div>
                                <Button
                                  onClick={exportLogs}
                                  size="sm"
                              ...
                              <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <span className="font-medium text-slate-800 dark:text-slate-200">Reset system</span>
                                </div>
                                <Button
                                  onClick={resetSystem}
                                  size="sm"
                          ...
                          <div className="space-y-6">
                            <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  <span className="font-medium text-slate-800 dark:text-slate-200">Voice alerts</span>
                                  <p className="text-sm text-slate-600 dark:text-slate-400">
                            ...
                            <div className="space-y-4 p-4 bg-slate-50 dark:bg-slate-700/50 rounded-xl">
                              <div className="flex items-center space-x-3">
                                ...
                                <label className="font-medium text-slate-800 dark:text-slate-200">Voice Volume</label>
                              </div>
                              <Slider
                              ...
                              <div className="grid grid-cols-4 gap-2">
                                {["low", "medium", "high", "critical"].map((level) => (
                                  <Button
                                    ...
                                    variant={settings.alertThreshold === level ? "default" : "outline"}
                                    size="sm"
